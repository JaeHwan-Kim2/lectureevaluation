...
<%
	...
	if(request.getParameter("lectureDivide") != null){
		lectureDivide = request.getParameter("letureDivide");
	}
...
<%--   			<select name="lectureDivide" class="form-control mx-1 mt-2">
			...
			<select name="searchType" class="form-control mx-1 mt-2">
				...
				<input type="text" name="search" class="form-control mx-1 mt-2" type="search" placeholder="내용을 입력하세요."aria-label="Search">
				<button type="submit" class="btn btn-primary mx-1 mt-2">검색</button>
			<a class="btn btn-primary mx-1 mt-2" data-toggle="modal" href="#registerModal">등록하기</a>
			<a class="btn btn-danger ml-1 mt-2" data-toggle="modal" href="#reportModal">신고하기</a>	
		</form>
<% 
...
%>
	<div class="card bg-light mt-3">
	        <div class="card-header bg-light">
	          <div class="row">
	            <div class="col-8 text-left"><b><%= evaluation.getLectureName() %></b>&nbsp;<small><%= evaluation.getProfessorName() %> 교수님</small></div>
